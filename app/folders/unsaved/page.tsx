"use client"
import { getUnsavedLinks } from "@/features/linkService/api"
...
function page() {
    ...
    const [unsavedLinks, setunsavedLinks] = useState<Link[]>([])
    ...
    useEffect(() => {
        async function fetchunsavedLinks() {
            try {
                const res = await getUnsavedLinks()
                setunsavedLinks(res.data)
